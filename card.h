...
class Card{
    ...
    Color getColor() const;// Accessor for card color. @return The enumerated color type
    
    int getNumber() const;// Accessor for card number. @return integer value of the card.
    
    void setColor(Color c);// Mutator for card color. @param c The enumerated color type for the card.
    
    void setNumber(int n);// Mutator for card number. @param n The integer value for the card.
